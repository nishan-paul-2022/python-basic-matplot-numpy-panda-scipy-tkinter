...
def ShowDialogs(method):
    ...
    if method == 13:
        ...
        print(ret)
    if method == 14:
        ret = simpledialog.askinteger("Integer Title", "This Is Simple Integer Input", parent=window, minvalue=0,
                                      maxvalue=100)
        print(ret)
    if method == 15:
        ret = simpledialog.askfloat("Float Title", "This Is Simple Float Input", parent=window, minvalue=0.0,
                                    maxvalue=100.0)
        print(ret)
...
button2 = Button(frame, text="Warning Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(2))
...
button4 = Button(frame, text="Question Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(4))
button4.grid(row=0, column=3, sticky="nsew", padx=10, pady=10)

# ===================================================
button5 = Button(frame, text="Yes No Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(5))
button5.grid(row=1, column=0, sticky="nsew", padx=10, pady=10)

button6 = Button(frame, text="Yes No Cancel Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(6))
button6.grid(row=1, column=1, sticky="nsew", padx=10, pady=10)

button7 = Button(frame, text="Ok Cancel Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(7))
button7.grid(row=1, column=2, sticky="nsew", padx=10, pady=10)

button8 = Button(frame, text="Retry Cancel Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(8))
button8.grid(row=1, column=3, sticky="nsew", padx=10, pady=10)

# =================================================
button9 = Button(frame, text="File Choose Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                 command=lambda: ShowDialogs(9))
button9.grid(row=2, column=0, sticky="nsew", padx=10, pady=10)

button10 = Button(frame, text="Multi File Choose Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                  command=lambda: ShowDialogs(10))
button10.grid(row=2, column=1, sticky="nsew", padx=10, pady=10)

button10 = Button(frame, text="File Save Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                  command=lambda: ShowDialogs(11))
button10.grid(row=2, column=2, sticky="nsew", padx=10, pady=10)

button11 = Button(frame, text="Color Pick Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                  command=lambda: ShowDialogs(12))
button11.grid(row=2, column=3, sticky="nsew", padx=10, pady=10)

# ========================================================
button12 = Button(frame, text="String Input Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                  command=lambda: ShowDialogs(13))
button12.grid(row=3, column=0, sticky="nsew", padx=10, pady=10)

button13 = Button(frame, text="Integer Input Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                  command=lambda: ShowDialogs(14))
button13.grid(row=3, column=1, sticky="nsew", padx=10, pady=10)

button14 = Button(frame, text="Float Input Dialog", padx=10, pady=10, bg="#C0392B", fg="white",
                  command=lambda: ShowDialogs(15))
