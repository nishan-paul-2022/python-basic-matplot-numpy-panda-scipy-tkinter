...
radio_male = Radiobutton(window, text="Male", value="M", variable=value_radio, indicatoron=0, width=10).pack(padx=15,
                                                                                                             pady=5,
                                                                                                             anchor=W)
radio_female = Radiobutton(window, text="Female", value="F", variable=value_radio, indicatoron=0, width=10).pack(
